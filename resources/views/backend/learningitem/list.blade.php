...
<div class="pcoded-main-container">
    <div class="pcoded-content">
     ...
     <p><a href="{{URL::route('newitem')}}" class="btn btn-info btn-sm"><span class="feather icon-plus"></span> New Item Entry</a>
     <a href="" class="btn btn-warning btn-sm">
     <span class="feather icon-plus"></span> Update Stock
     </a>
     </p>
                                ...
                                <tbody>
                                  ...
                                  @foreach($items as $item)  
                                    <tr>
                                        ...
                                        <td>{{$item->isbn}}</td>
                                        <td>{{$item->title}}</td>
                                        <td><a href="{{URL::route('relatedsubjects' , $item->id)}}">{{$item->subject}}</a></td>
                                        <td><a href="#"> {{$item->publisher}}</a></td>   
                                        <td><a href="{{URL::route('authordetails' , $item->id)}}"> {{$item->author}}</a></td>
